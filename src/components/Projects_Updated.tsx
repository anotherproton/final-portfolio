  ...
  const projects = [
    {
      ...
      category: 'DTF Order System',
      description: 'Built a dynamic DTF order system with live pricing calculator, boosting checkout rate by ~20%. Automated invoicing reduced manual work by ~90%.',
      image: 'https://images.pexels.com/photos/325876/pexels-photo-325876.jpeg',
      technologies: ['Shopify', 'Liquid', 'JavaScript', 'Automation'],
    },
    {
      title: 'Mum & You (mumandyou.com)',
      category: 'eCommerce Migration',
      description: 'Migrated UK brand from Magento to Shopify, developed custom subscription model and private apps for real-time inventory sync.',
      image: 'https://images.pexels.com/photos/325876/pexels-photo-325876.jpeg',
      technologies: ['Shopify', 'API', 'Private Apps', 'Subscription Flows'],
    },
    {
      title: 'Nicobar (nicobar.com)',
      category: 'Brand-centric Theme',
      description: 'Optimized loading times by 42%, created custom Liquid blocks and filtering to improve UX and increase click-through rate.',
      image: 'https://images.pexels.com/photos/325876/pexels-photo-325876.jpeg',
      technologies: ['Liquid', 'Theme Dev', 'UX', 'Performance'],
    },
    {
      title: 'Mahina (mahina.co)',
      category: 'Performance Optimization',
      description: 'Built a custom Shopify theme from Figma, achieved 95+ PageSpeed score, integrated upsell & bundle logic to grow AOV by 28%.',
      image: 'https://images.pexels.com/photos/325876/pexels-photo-325876.jpeg',
      technologies: ['Shopify', 'UX Design', 'AOV Strategy', 'Theme Optimization'],
    },
    {
      title: 'The Aangan',
      category: 'Conversion-Focused Store',
      description: 'Designed a babywear Shopify store with custom filters and upsells, leading to 32% sales growth and 19% AOV increase.',
      image: 'https://images.pexels.com/photos/325876/pexels-photo-325876.jpeg',
      technologies: ['Shopify', 'UX Personalization', 'Conversion'],
    }
    {
